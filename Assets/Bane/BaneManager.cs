...
public class BaneManager : MonoBehaviour
{
    ...
    {
        powerUpUI.ActivateBane(PowerUpUI.BaneType.BlurryVision, duration);
    ...
    {
        powerUpUI.ActivateBane(PowerUpUI.BaneType.Frictionless, duration);
    ...
    {
        powerUpUI.ActivateBane(PowerUpUI.BaneType.SpeedReduction, duration);
